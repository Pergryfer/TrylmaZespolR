...
public class PlanszaGwiazda {
    ...
    private void dodajPionki(){
        ...
        if(liczbaGraczy >= 4) {
                ...
                pola[6][4] = pionki.get(27).id;
                pola[6][6] = pionki.get(28).id;
        ...
        if(liczbaGraczy == 6){
                pola[4][24] = pionki.get(40).id;
                pola[4][22] = pionki.get(41).id;
                pola[4][20] = pionki.get(42).id;
                pola[4][18] = pionki.get(43).id;
                pola[5][23] = pionki.get(44).id;
                pola[5][21] = pionki.get(45).id;
                pola[5][19] = pionki.get(46).id;
                pola[6][22] = pionki.get(47).id;
                pola[6][20] = pionki.get(48).id;
